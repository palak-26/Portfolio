...
const Skills = () => {
  ...
  return (
    <div id="Skills" className="min-h-screen w-full py-16 justify-center items-center  px-6 md:px-12 lg:px-20 flex flex-col bg-gradient-to-r from-purple-950 via-indigo-700 to-purple-950  dark:from-slate-950 dark:via-slate-800 dark:to-slate-950 dark:transition-all dark:duration-100">
