...
const Projects = () => {
  ...
  return (
    <div
      id="Projects"
      className="min-h-screen w-full px-4  md:px-10 lg:px-20 flex flex-col gap-10 items-center justify-center bg-gradient-to-r from-purple-950 via-indigo-700 to-purple-950"
    >
      {/* Heading */}
