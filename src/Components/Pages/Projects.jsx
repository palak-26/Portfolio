...
const Projects = () => {
  ...
  return (
    <div
      id="Projects"
      className="relative min-h-screen w-full px-4 md:px-10 lg:px-20 py-32 flex flex-col gap-10 overflow-y-scroll scroll-smooth scrollbar-hide items-center justify-center bg-gradient-to-br from-[#2E005B] via-[#5B0EAB] to-[#32008E] text-white dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-500 dark:to-slate-950"
    >
      ...
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-[#7b2cbf] rounded-full blur-[200px] opacity-20 z-0"></div>
      <div className="absolute inset-0 bg-gradient-to-br from-[#1a002f] via-[#6a00ff] to-[#1a002f] opacity-80 z-0"></div>
      ...
      <div className="relative z-10 w-full flex flex-col gap-10 items-center">
        ...
        <div className="shadow-lg bg-transparent dark:bg-white/20 shadow-black rounded-3xl dark:backdrop-blur-2xl overflow-y-scroll scroll-smooth scrollbar-hide py-20 px-10 flex flex-wrap justify-center gap-8 max-w-[90%] ">
          {projects.slice(0, visibleCount).map((item) => (
            <motion.div
              ...
              className="bg-[#ffffff0d] backdrop-blur-xl hover:scale-110 transition-all duration-700 flex flex-col gap-4 duration-700 bg-black/30 lg:p-10 p-6 dark:bg-white/50 border-none rounded-3xl w-[100%] sm:w-64 h-96 items-center justify-center text-center shadow-md shadow-black cursor-pointer"
            >
              <img src={item.img} alt={item.item} className="rounded-md" />
              <h3 className="text-white font-bold text-base lg:text-lg dark:text-black dark:font-semibold">
                {item.item}
              </h3>
              <h4 className="text-slate-400 font-bold dark:text-slate-900 text-sm">
                Status: {item.status}
              </h4>
              <div className="text-white flex items-end justify-center w-auto dark:text-black">
