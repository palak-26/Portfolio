...
const About = () => {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="flex flex-col  lg:flex-row gap-x-20 items-center justify-evenly justify-center gap-10 max-w-7xl w-full">
        {/* Image */}
        <motion.div
          variants={scale}
          initial="hidden"
        ...
        >
          <div className='sm:h-56 sm:w-56 md:h-60 md:w-60 lg:h-72 lg:w-72'>
            <img
            src={photo}
            alt="Palak"
