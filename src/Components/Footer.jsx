        ...
        <div className="text-center lg:text-center space-y-4 max-w-2xl">
          ...
          <div className="flex flex-wrap justify-center lg:justify-center gap-4 text-sm text-blue-400 font-bold">
            ...
            <a href="/resume.pdf" target="_blank" className="hover:underline flex items-center gap-2">
              <FaFile className="dark:text-white" /> Resume
            </a>
          </div>

          {/* Credits */}
          <p className="text-sm dark:text-gray-500">
            Designed & built by <span className="dark:text-white font-semibold">Palak Neekhra</span> • © 2025
          </p>
